    ...
    <script src="<%if (content.rootpath) {%>${content.rootpath}<% } else { %><% }%>js/jquery.min.js"></script>
    <script src="<%if (content.rootpath) {%>${content.rootpath}<% } else { %><% }%>js/popper.min.js"></script>
    ...
    <script src="<%if (content.rootpath) {%>${content.rootpath}<% } else { %><% }%>js/custom.js"></script>
  </body>
</html>