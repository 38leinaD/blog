...
<nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-primary">
  ...
  <div class="container">
    <a class="navbar-brand" href="<%if (content.rootpath) {%>${content.rootpath}<% } else { %><% }%>">dplatz.de</a>
    ...
    <div class="collapse navbar-collapse" id="navbarColor01">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item"><a class="nav-link" href="<%if (content.rootpath) {%>${content.rootpath}<% } else { %><% }%>${config.feed_file}">Subscribe</a></li>
