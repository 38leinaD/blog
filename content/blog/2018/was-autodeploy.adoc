...
NOTE: Since this post I have extended the `was-9` container that you can directly mount `/opt/IBM/WebSphere/AppServer/profiles/AppSrv01/monitoredDeployableApps/servers/server1/`.
...
Instead, the container will do a touch on anyWAR/EAR in this folder once the auto-deploy service is watching the folder.
