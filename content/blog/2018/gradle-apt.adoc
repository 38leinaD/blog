...
At this point, your annotation-processor should work fine; also from within Eclipse. But in case you annotation-processor is generating Java classes, you will not see the im Eclipse because they are generated to `build/generated/sources(apt/main`.

I have found two ways to deal with it.

* Either, generate them to `src/main/generated` or similar in case you have some need to also check them in source-control.
+
[source,groovy]
----
compileJava {
