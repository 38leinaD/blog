= Deploying a Java EE 7 Application to Google Cloud
.
2018-05-29
:jbake-type: post
...
You can now try to open link:http://<ip>/hello/resources/health[http://<ip>/hello/resources/health] in your browser of with cURL. You should get an "UP" response.
